...
declare module PIXI
{
  ...
  /* MODULE FUNCTIONS */
  export function autoDetectRenderer(width:number, height:number, view?:HTMLCanvasElement, transparent?:boolean, antialias?:boolean):Renderer;
  ...
  export interface CharInfo {
	...
	export class DisplayObject
	{
		...
		worldAlpha: number;
		constructor();
		static autoDetectRenderer(width: number, height: number, view?: HTMLCanvasElement, transparent?: boolean): Renderer;
