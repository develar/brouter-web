...
declare module L {
  ...
  export class GridLayer extends Layer {
    ...
    _tiles:{ [key: string]: any; };

    constructor(url:String, options:GridLayerOptions);
    ...
    _getTileNumBounds():Bounds;

    _addValidatedTiles(tilesToLoad:Number, queue:Array<Point>);

    _getTilePos(coords:Point):Point;

    _wrapCoords(coords:Point):void;
    ...
    export class TileLayer extends GridLayer implements ILayer, IEventPowered<TileLayer> {
